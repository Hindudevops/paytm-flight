...
public class 3  {
	...
	/**
	 * Main entry point that creates an instance of flight and starts it.
	...
	public static void main(String[] args) {
		...
		// Create a new flight instance, put the output stream on the system log
		3 program = new 3(inputFilePath, 7777, System.out);
	 ...
	 */
	public 3 (String inputFilePath, int port, Appendable out) {
